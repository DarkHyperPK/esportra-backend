...
public static class SponsorPlacementPolicy
{
    private static readonly IReadOnlyDictionary<string, PlacementZonePolicy> Policies =
        new Dictionary<string, PlacementZonePolicy>(StringComparer.Ordinal)
        {
            ...
            ["sidebar_partner"] = Create("sidebar_partner", false, 2, SponsorCreativeRole.Banner, 600, 1200, 0.42, 0.58, "ascendant", "radiant"),
            ["wide_partner"] = Create("wide_partner", false, 4, SponsorCreativeRole.Banner, 1200, 525, 1.75, 2.3, "ascendant", "radiant"),
