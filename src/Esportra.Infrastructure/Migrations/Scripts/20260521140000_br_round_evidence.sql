-- ============================================================================
-- Migration: BR Round Evidence
-- Purpose:   Store BR evidence per relational round instead of legacy game blobs
--            so organizer review works for multi-group and solo tournaments.
-- ============================================================================
