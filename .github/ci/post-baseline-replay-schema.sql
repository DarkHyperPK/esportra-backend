...
--
-- This file represents the exact staging schema state after all applied
-- migrations. CI applies this, seeds the journal, then runs only new
-- (unapplied) migrations via DbUp.
...
-- ── Extensions (minimal set needed by public schema) ─────────────────────────
